                  ...
                  child:TransformerPageView(
                      onPageChanged:(page){
                        ...
                        page==0?null:card_model.all_refresh(
                            others.trigger1?card_model.flaggList[card_model.flaggList.length-page]
                                :card_model.shuffled_flaggList[card_model.flaggList.length-page]);
                      },
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        if(index==0){
                          ...
                          others.trigger1?card_model.flaggList[card_model.flaggList.length-index]
                              :card_model.shuffled_flaggList[card_model.flaggList.length-index],
                              index:index);
                        }},
      ...
      Container(
        ...
        child: Stack(children:[
          Container(
            ...
            top: 15,right: 50,child: Icon(Icons.flag,color: Color(0XFF646464),size: 30,),
          ),
          Positioned(
              top: 20,left: 30,
              child: Container(
            ...
            children:[
              ...
              Container(
                child: context.select((Others value) =>value.tab_triger)?null:Text(index.toString()+" / "+
                    context.select((CardsModel value) =>value.flaggList.length.toString())
